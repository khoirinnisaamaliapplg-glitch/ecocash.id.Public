    ...
    <section id="community" className="max-w-7xl mx-auto px-6 lg:px-10 py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 bg-eco-cyan/10 text-eco-primary px-5 py-2.5 rounded-full font-heading text-sm font-semibold">
          ...
          <p className="text-lg text-slate-600 leading-relaxed font-body">
            Bersama <strong className="text-eco-primary">EcoCash.id</strong>,
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center bg-eco-primary hover:bg-eco-primary/90 text-white px-9 py-4 rounded-full font-heading font-bold transition-all shadow-led-glow hover:-translate-y-1"
          >
